...
This is a port of the famous FastLED library to MicroPython.
This port is currently under development and initially is only going to work 
on the ESP32 and posibally the ESP8266

https://github.com/FastLED/FastLED

<br>

I am in need of a willing person that has the knowledge to write the "drivers" 
for the various LED chipsets. Currently MicroPython has support for NeoPixels and 
I would like to see support for other chipsets as well. This needs to be written in 
c/cpp because high accuracy of the timings are needed. If you are a willing and 
knowledgeable person create an issue and let me know. I would like to explain 
the game plan.  

<br>
I have done my best so far to keep the FastLED API in tact. what this means is porting 
existing code that uses the FastLED library over to Python would be a painless process.
I would be more then willing to help anyone port their code if they need help doing it.
